package com.dmitry.bogdanov.underground.config;
...
@Configuration
@EnableJpaRepositories("com.dmitry.bogdanov.underground.repository")
@EnableTransactionManagement
@PropertySource("classpath:db.properties")
@ComponentScan("com.dmitry.bogdanov.underground")
